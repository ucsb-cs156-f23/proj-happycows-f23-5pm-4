...
export default function CommonsTable({ commons, currentUser }) {
    ...
    const columns = [
        ...
        {
            Header: <span>Starting<br />Balance</span>,
        ...
        {
            Header: <span>Show<br />Ldrboard</span>,
